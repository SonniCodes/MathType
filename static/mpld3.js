...
!(function (t, n) {
    ...
    function B(t, n) {
        ...
        function l(l) {
            ...
            (m = m.merge(m.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor"))),
                ...
                w.remove(),
                m.attr("d", t === D || t == R ? (a ? "M" + f * a + "," + g + "H0.5V" + y + "H" + f * a : "M0.5," + g + "V" + y) : a ? "M" + g + "," + f * a + "V0.5H" + y + "V" + f * a : "M" + g + ",0.5H" + y),
        ...
        return 1 === arguments.length
            ? (function (t) {
                  ...
                  var n = (t = t.rgb()).r / 255,
                      ...
                      u = o - i,
                      f = (o + i) / 2;
                  return u ? ((a = n === o ? (e - r) / u + 6 * (e < r) : e === o ? (r - n) / u + 2 : (n - e) / u + 4), (u /= f < 0.5 ? o + i : 2 - o - i), (a *= 60)) : (u = f > 0 && f < 1 ? 0 : a), new An(a, u, f, t.opacity);
              })(t)
    ...
    function Dn(t) {
        ...
        return i === o && o === a ? (e = r = u) : ((e = On((0.4360747 * i + 0.3850649 * o + 0.1430804 * a) / En)), (r = On((0.0139322 * i + 0.0971045 * o + 0.7141733 * a) / Cn))), new qn(116 * u - 16, 500 * (e - u), 200 * (u - r), t.opacity);
    }
    function Un(t, n, e, r) {
    ...
    Kt(
        ...
        tn(nn, {
            ...
            rgb: function () {
                ...
                return new mn(Bn(3.1338561 * (n = En * Yn(n)) - 1.6168667 * (t = kn * Yn(t)) - 0.4906146 * (e = Cn * Yn(e))), Bn(-0.9787684 * n + 1.9161415 * t + 0.033454 * e), Bn(0.0719453 * n - 0.2289914 * t + 1.4052427 * e), this.opacity);
            },
        })
    ),
        Kt(
    ...
    Kt(
        ...
        tn(nn, {
            brighter: function (t) {
                return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new te(this.h, this.s, this.l * t, this.opacity);
            },
            darker: function (t) {
    ...
    function be(t, n) {
        var e,
            ...
            u = [],
            f = [];
        for (t += "", n += ""; (e = ye.exec(t)) && (r = _e.exec(n)); ) (i = r.index) > o && ((i = n.slice(o, i)), u[a] ? (u[a] += i) : (u[++a] = i)), (e = e[0]) === (r = r[0]) ? (u[a] ? (u[a] += r) : (u[++a] = r)) : ((u[++a] = null), f.push({ i: a, x: ve(e, r) })), (o = _e.lastIndex);
        return (
    ...
    function Ee(t, n, e, r, i, o) {
        var a, u, f;
        return (a = Math.sqrt(t * t + n * n)) && ((t /= a), (n /= a)), (f = t * e + n * r) && ((e -= t * f), (r -= n * f)), (u = Math.sqrt(e * e + r * r)) && ((e /= u), (r /= u), (f /= u)), t * r < n * e && ((t = -t), (n = -n), (f = -f), (a = -a)), { translateX: i, translateY: o, rotate: Math.atan2(n, t) * Ne, skewX: Math.atan(f) * Ne, scaleX: a, scaleY: u };
    }
    function ke(t, n, e, r) {
        function i(t) {
        ...
        return function (o, a) {
            ...
            return (
                ...
                (function (t, n, e, o) {
                    t !== n ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360), o.push({ i: e.push(i(e) + "rotate(", null, r) - 2, x: ve(t, n) })) : n && e.push(i(e) + "rotate(" + n + r);
                })(o.rotate, a.rotate, u, f),
                (function (t, n, e, o) {
                    t !== n ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: ve(t, n) }) : n && e.push(i(e) + "skewX(" + n + r);
                })(o.skewX, a.skewX, u, f),
    ...
    function wr(t, n, e, r, i, o) {
        ...
        })(t, e, { name: n, index: r, group: i, on: dr, tween: pr, time: o.time, delay: o.delay, duration: o.duration, ease: o.ease, timer: null, state: vr });
    }
    function Mr(t, n) {
        var e = Tr(t, n);
    ...
    function Ri(n) {
        ...
        function l() {
            ...
            function Y() {
                ...
                l < o && ((w *= -1), (t = r), (r = s), (s = t), (t = o), (o = l), (l = t), m in Ai && U.attr("cursor", Mi[(m = Ai[m])])),
                    d < u && ((M *= -1), (t = a), (a = h), (h = t), (t = u), (u = d), (d = t), m in Ti && U.attr("cursor", Mi[(m = Ti[m])])),
        ...
        function u(e, r, i) {
            e.forEach(function (e) {
                var o,
                    ...
                    c = 0 | u,
                    s = r[c * t + f];
                a > 0 && a < t && f === a && ((o = r[c * t + f - 1]), (e[0] = a + (i - o) / (s - o) - 0.5)), u > 0 && u < n && c === u && ((o = r[(c - 1) * t + f]), (e[1] = u + (i - o) / (s - o) - 0.5));
            });
        }
        return (
            (i.contour = o),
    ...
    (aa.copy = function () {
        ...
        for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); ) for (var i = 0; i < 4; ++i) (n = r.source[i]) && (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = oa(n)));
        return e;
    }),
        (aa.add = function (t) {
            ...
            return {
                ...
                point: function (o, a) {
                    var u = o > 0 ? qa : -qa,
                        f = Ha(o - e);
                    Ha(f - qa) < Da
                        ? (t.point(e, (r = (r + a) / 2 > 0 ? Oa : -Oa)), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), t.point(o, r), (n = 0))
                        : i !== u &&
                          f >= qa &&
                          (Ha(e - i) < Da && (e -= i * Da),
                          Ha(o - u) < Da && (o -= u * Da),
                  ...
                  function e(r, i, o, a, u, f, c, s, l, h, d, p, v, g) {
                      ...
                      if (b > 4 * n && v--) {
                          var m = a + h,
                              ...
                              C = E - i,
                              P = _ * k - y * C;
                          ((P * P) / b > n || Ha((y * k + _ * C) / b - 0.5) > 0.3 || a * h + u * d + f * p < Ns) && (e(r, i, o, a, u, f, S, E, T, (m /= M), (x /= M), w, v, g), g.point(S, E), e(S, E, T, m, x, w, c, s, l, h, d, p, v, g));
                      }
                  }
                  return function (n) {
                      var r,
    ...
    function Ps(t) {
        ...
        return (
            ...
            (T.clipExtent = function (t) {
                return arguments.length
                    ? ((M = null == t ? ((w = r = i = o = null), mc) : Zf((w = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))), E())
                    : null == w
                    ? null
                    : [
                          [w, r],
    ...
    function Ds() {
        return Ls().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-0.6, 38.7]);
    }
    function Us(t) {
        return function (n, e) {
            var r = Ga(n),
    ...
    function Fs(t) {
        ...
        return (
            ...
            (i.clipExtent = function (t) {
                return arguments.length
                    ? (null == t ? (c = n = e = r = null) : ((c = +t[0][0]), (n = +t[0][1]), (e = +t[1][0]), (r = +t[1][1])), s())
                    : null == c
                    ? null
                    : [
                          [c, n],
    ...
    function Wl(t, n, e, r, i, o) {
        for (var a, u, f, c, s, l, h, d, p, v, g, y = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x; ) {
            ...
            y.push((a = { value: s, dice: f < c, children: _.slice(b, m) })), a.dice ? Dl(a, e, r, i, w ? (r += (c * s) / w) : o) : Vl(a, e, r, w ? (e += (f * s) / w) : i, o), (w -= s), (b = m);
        }
        return y;
    }
    var Zl = (function t(n) {
        ...
        Dy = {
            draw: function (t, n) {
                var e = Math.sqrt(n / Ly),
                    ...
                    u = -o,
                    f = a;
                t.moveTo(r, i), t.lineTo(o, a), t.lineTo(u, f), t.lineTo(-0.5 * r - zy * i, zy * r + -0.5 * i), t.lineTo(-0.5 * o - zy * a, zy * o + -0.5 * a), t.lineTo(-0.5 * u - zy * f, zy * u + -0.5 * f), t.lineTo(-0.5 * r + zy * i, -0.5 * i - zy * r), t.lineTo(-0.5 * o + zy * a, -0.5 * a - zy * o), t.lineTo(-0.5 * u + zy * f, -0.5 * f - zy * u), t.closePath();
            },
        },
        ...
        (h_.prototype = {
            ...
            lineEnd: function () {
                ...
                if (e)
                    ...
                    else for (var r = d_(t), i = d_(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
    ...
    (ub.prototype = ob.prototype),
        ...
        (t.thresholdFreedmanDiaconis = function (t, e, r) {
            return (t = d.call(t, u).sort(n)), Math.ceil((r - e) / (2 * (A(t, 0.75) - A(t, 0.25)) * Math.pow(t.length, -1 / 3)));
        }),
        ...
        (t.forceSimulation = function (t) {
            ...
            function l() {
                ...
                for (
                    ...
                    null == (r = t[n]).fx ? (r.x += r.vx *= a) : ((r.x = r.fx), (r.vx = 0)), null == r.fy ? (r.y += r.vy *= a) : ((r.y = r.fy), (r.vy = 0));
            }
            function h() {
        ...
        (t.geoCircle = function () {
            ...
            function a() {
                ...
                return (t = []), (n = kf(-a[0] * Ia, -a[1] * Ia, 0).invert), Lf(o, u, f, 1), (a = { type: "Polygon", coordinates: [t] }), (t = n = null), a;
            }
            return (
                (a.center = function (t) {
            ...
            return (
                (s.invert = function (t) {
                    var n = a.scale(),
                        ...
                        r = (t[0] - e[0]) / n,
                        i = (t[1] - e[1]) / n;
                    return (i >= 0.12 && i < 0.234 && r >= -0.425 && r < -0.214 ? u : i >= 0.166 && i < 0.234 && r >= -0.214 && r < -0.115 ? f : a).invert(t);
                }),
                (s.stream = function (e) {
                    return t && n === e
                        ? t
                ...
                (s.scale = function (t) {
                    return arguments.length ? (a.scale(t), u.scale(0.35 * t), f.scale(t), s.translate(a.translate())) : a.scale();
                }),
        ...
        (t.geoIdentity = function () {
            ...
            return (o = {
                ...
                clipExtent: function (r) {
                    return arguments.length
                        ? ((d = null == r ? ((h = t = n = e = null), mc) : Zf((h = +r[0][0]), (t = +r[0][1]), (n = +r[1][0]), (e = +r[1][1]))), p())
                        : null == h
                        ? null
                        : [
                              [h, t],
        ...
        (t.scaleDiverging = function t(n) {
            ...
            return (
                (f.domain = function (t) {
                    return arguments.length ? ((e = +t[0]), (r = +t[1]), (i = +t[2]), (o = e === r ? 0 : 0.5 / (r - e)), (a = r === i ? 0 : 0.5 / (i - r)), f) : [e, r, i];
                }),
                (f.clamp = function (t) {
        ...
        (t.interpolateSinebow = function (t) {
            var n;
            return (t = (0.5 - t) * Math.PI), (Tg.r = 255 * (n = Math.sin(t)) * n), (Tg.g = 255 * (n = Math.sin(t + Ng)) * n), (Tg.b = 255 * (n = Math.sin(t + Sg)) * n), Tg + "";
        }),
        ...
        (t.pie = function () {
            ...
            function a(a) {
                ...
                for (
                    ...
                    (f = p[u]), (s = g + ((l = v[f]) > 0 ? l * c : 0) + b), (v[f] = { data: a[f], index: u, value: l, startAngle: g, endAngle: s, padAngle: _ });
                return v;
            }
            return (
                (a.value = function (n) {
