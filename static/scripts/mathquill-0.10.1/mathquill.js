...
(function () {
    ...
    var Cursor = P(Point, function (_) {
        _.init = function (initParent, options) {
            ...
            var jQ = (this.jQ = this._jQ = $('<span class="mq-cursor" id="mq-cursor-focus">&#8203;</span>'));
    ...
    function insistOnInterVer() {
        if (window.console) console.warn("You are using the MathQuill API without specifying an interface version, " + "which will fail in v1.0.0. Easiest fix is to do the following before " + "doing anything else:\n" + "\n" + "    MathQuill = MathQuill.getInterface(1);\n" + "    // now MathQuill.MathField() works like it used to\n" + "\n" + 'See also the "`dev` branch (2014\u20132015) \u2192 v0.10.0 Migration Guide" at\n' + "  https://github.com/mathquill/mathquill/wiki/%60dev%60-branch-(2014%E2%80%932015)-%E2%86%92-v0.10.0-Migration-Guide");
    }
    ...
    function getInterface(v) {
         ...
         * static math or math or text field, retu ns an API object for it (else, null).
         *
    ...
    Controller.open(function (_) {
        Options.p.substituteTextarea = function () {
            return $('<textarea autocapitalize=off autocomplete=off autocorrect=off spellcheck=false x-palm-disable-ste-all=true mq-textarea-id=""/>')[0];
        };
        _.createTextarea = function () {
            var textareaSpan = (this.textareaSpan = $('<span class="mq-textarea"></span>')),
                textarea = this.options.substituteTextarea();
            if (!textarea.nodeType) {
                throw "substituteTextarea() must rmq-text-modeeturn a DOM element, got " + textarea;
            }
  ...
  */
    ...
    var TextBlock = P(Node, function (_, super_) {
        ...
        _.createLeftOf = function (cursor) {
            ...
            if (textBlock.replacedText) for (var i = 0; i < textBlock.replacedText.length; i += 1) textBlock.write(cursor, textBlock.replacedText.charAt(i));
        };
    ...
    LatexCmds["\u2217"] = LatexCmds.ast = LatexCmds.star = LatexCmds.loast = LatexCmds.lowast = bind(BinaryOperator, "\\ast ", "&lowast;");
    ...
    LatexCmds.N = LatexCmds.naturals = LatexCmds.Naturals = bind(VanillaSymbol, "\\mathbb{N}", "<span class='mq-pseudo-mathbb'>&#8469;</span>");
    ...
    LatexCmds.Z = LatexCmds.integers = LatexCmds.Integers = bind(VanillaSymbol, "\\mathbb{Z}", "<span class='mq-pseudo-mathbb'>&#8484;</span>");

    LatexCmds.Q = LatexCmds.rationals = LatexCmds.Rationals = bind(VanillaSymbol, "\\mathbb{Q}", "<span class='mq-pseudo-mathbb'>&#8474;</span>");

    LatexCmds.R = LatexCmds.reals = LatexCmds.Reals = bind(VanillaSymbol, "\\mathbb{R}", "<span class='mq-pseudo-mathbb'>&#8477;</span>");
    ...
    LatexCmds.H = LatexCmds.Hamiltonian = LatexCmds.quaternions = LatexCmds.Quaternions = bind(VanillaSymbol, "\\mathbb{H}", "<span class='mq-pseudo-mathbb'>&#8461;</span>");
...
*/
    ...
    var Variable = P(Symbol, function (_, super_) {
        _.init = function (ch, html) {
            var cssClass;
            if (ch == ch.toLowerCase() && !(ch == "b" || ch == "d" || ch == "h" || ch == "k" || ch == "l" || ch == "t")) {
                cssClass = "mq-short";
            } else {
                cssClass = "mq-tall";
            }
            super_.init.call(this, ch, "<var class='" + cssClass + "'>" + (html || ch) + "</var>");
        };
        _.text = function () {
    ...
    LatexCmds["'"] = LatexCmds.prime = bind(VanillaSymbol, "'", '<span class="mq-prime">&prime;</span>');
    ...
    LatexCmds.pi = LatexCmds["\u03c0"] = bind(NonSymbolaSymbol, "\\pi ", "<span class='mq-pi'>&pi;</span>");
    ...
    LatexCmds.mathcal = bind(Style, "\\mathcal", "span", 'class="mq-mathcal"');
    LatexCmds.mathscr = bind(Style, "\\mathscr", "span", 'class="mq-mathscr"');
    LatexCmds.mathbb = bind(Style, "\\mathbb", "span", 'class="mq-mathbb"');
    LatexCmds.mathfrak = bind(Style, "\\mathfrak", "span", 'class="mq-mathfrak"');
    ...
    LatexCmds.dot = P(MathCommand, function (_, super_) {
        _.init = function () {
            super_.init.call(this, "\\dot", '<span class="mq-non-leaf"><span class="mq-dot-recurring-inner">' + '<span class="mq-dot-recurring">&#x2d9;</span>' + '<span class="mq-empty-box">&0</span>' + "</span></span>");
        };
    });
    ...
    var SummationNotation = P(MathCommand, function (_, super_) {
        _.init = function (ch, html) {
            var htmlTemplate = '<span class="mq-large-operator mq-non-leaf">' + '<span class="mq-to mq-tabbable-upper"><span>&1</span></span>' + "<big>" + html + "</big>" + '<span class="mq-from mq-tabbable-lower"><span>&0</span></span>' + "</span>";
    ...
    LatexCmds["\u2211"] = LatexCmds.sum = LatexCmds.summation = bind(SummationNotation, "\\sum", `<svg viewBox="1.002 0.505 118.375 120.422" style="height: 1.67em; width:auto;" xmlns="http://www.w3.org/2000/svg"> <path d="M 15.734 114.783 L 87.838 114.783 C 107.703 114.374 118.558 95.122 118.558 95.122 C 118.558 95.122 109.342 120.313 109.342 120.927 L 4.713 120.927 L 50.359 66.45 L 1.002 0.505 L 109.814 0.505 L 119.377 23.442 C 119.377 23.442 112.004 3.577 67.153 4.396 L 18.542 4.396 C 18.542 4.396 60.19 60.921 60.395 60.921 C 60.6 60.921 15.543 114.783 15.543 114.783"> </path> </svg>`);

    LatexCmds["\u220f"] = LatexCmds.prod = LatexCmds.product = bind(SummationNotation, "\\prod", `<svg viewBox="0 0 41.121 49.231" style="height: 1.67em; width:auto; margin: 0 0.2em; margin-bottom: -2px;" xmlns="http://www.w3.org/2000/svg"> <path style="stroke: rgba(108, 96, 96, 0);" d="M 0.023 -0.058 L 0.023 2.096 C 6.082 1.773 5.823 4.553 5.823 4.553 L 5.823 43.861 C 5.934 47.702 0.037 47.202 0.037 47.202 L 0.037 49.151 L 17.282 49.151 L 17.261 47.142 C 11.422 47.205 11.783 44.599 11.783 44.599 L 11.783 1.984 L 29.315 1.984 L 29.315 44.159 C 29.394 47.607 23.672 47.417 23.672 47.417 L 23.672 49.173 L 40.799 49.173 L 40.857 47.071 C 34.953 47.281 35.252 44.102 35.252 44.102 L 35.252 6.731 C 35.252 1.414 41.144 1.939 41.144 1.939 L 41.144 -0.052 L 0.123 -0.052 L 0.023 -0.058 Z"></path> </svg>`);

    LatexCmds.bigcap = LatexCmds.summation = bind(SummationNotation, "\\bigcap", "&#8745;");

    LatexCmds.bigcup = LatexCmds.product = bind(SummationNotation, "\\bigcup", "&#8746;");
    ...
    LatexCmds["\u222b"] =
        ...
        LatexCmds.integral =
            P(SummationNotation, function (_, super_) {
                _.init = function () {
                    const integralSymbol = `<svg style="height: 2.75em; width:auto;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 205 500"> <ellipse style="stroke: rgba(0, 0, 0, 0.19); stroke-width: 0.2px;" cx="189.794" cy="23.362" rx="11.161" ry="11.161"></ellipse> <path style="stroke-width: 0.2px; stroke: rgba(0, 0, 0, 0);" d="M 201.025 22.786 C 201.025 22.786 201.433 23.502 200.199 17.337 C 198.965 11.171 190.815 6.182 186.682 4.558 C 182.55 2.934 174.026 0.312 164.536 7.265 C 155.047 14.219 145.475 38.671 145.624 38.641 C 145.023 38.46 135.091 70.272 121.113 129.443 C 107.136 188.615 93.458 256.025 93.679 256.025 C 93.679 256.025 95.229 247.403 88.396 283.589 C 81.563 319.774 79.792 331.922 68.911 392.654 C 58.03 453.385 46.075 491.571 29.14 493.426 C 12.206 495.281 3.438 474.209 3.438 474.209 L 2.327 473.612 C 2.327 473.612 -1.426 487.946 15.809 495.455 C 33.044 502.964 45.246 490.933 48.402 488.8 C 51.558 486.667 66.504 470.384 79.461 420.066 C 92.418 369.748 99.625 337.591 99.625 337.591 C 99.625 337.591 109.043 301.616 120.202 240.329 C 131.361 179.041 140.13 127.49 149.882 78.211 C 159.634 28.931 168.994 13.12 170.662 11.784 C 172.331 10.449 172.998 7.448 178.447 7.336 C 183.896 7.224 190.902 12.563 190.902 12.563 L 201.025 22.786 Z"></path> <ellipse style="stroke: rgba(0, 0, 0, 0);" cx="12.981" cy="477.361" rx="11.295" ry="11.295"></ellipse> </svg>`;
                    var htmlTemplate = '<span class="mq-int mq-non-leaf mq-large-operator">' + integralSymbol + '<span class="mq-supsub mq-int-bounds mq-non-leaf">' + '<span class="mq-sup"><span class="mq-sup-inner mq-tabbable-upper">&1</span></span>' + '<span class="mq-sub mq-tabbable-lower">&0</span>' + '<span style="display:inline-block;width:0">&#8203</span>' + "</span>" + "</span>";
                    Symbol.prototype.init.call(this, "\\int", htmlTemplate);
                };
                // FIXME: refactor rather than overriding
                _.createLeftOf = MathCommand.p.createLeftOf;
            });
    LatexCmds["eval"] = LatexCmds.eval = P(SummationNotation, function (_, super_) {
        _.init = function () {
            const integralSymbol = `<span style="position: relative; bottom: 7px;margin-bottom: -7px; padding-bottom: -7px"><svg viewBox="0 0 2.145 139.812" style="height: 2em; width:auto;margin-left: 4px; margin-right: 2px;"> <rect x="0.001" y="-0.001" width="2.145" height="139.812" style="stroke: rgba(0, 0, 0, 0);"></rect> </svg></span>`;
            var htmlTemplate = '<span class="mq-eval mq-non-leaf">' + integralSymbol + '<span class="mq-supsub mq-eval-bounds mq-non-leaf">' + '<span class="mq-sup"><span class="mq-sup-eval-inner mq-tabbable-upper">&1</span></span>' + '<span class="mq-sub mq-sub-eval mq-tabbable-lower">&0</span>' + '<span style="display:inline-block;width:0">&#8203</span>' + "</span>" + "</span>";
            Symbol.prototype.init.call(this, "\\eval", htmlTemplate);
        };
        // FIXME: refactor rather than overriding
        _.createLeftOf = MathCommand.p.createLeftOf;
    });
    ...
    LatexCmds["\u222E"] =
        ...
        LatexCmds.integral =
            P(SummationNotation, function (_, super_) {
                _.init = function () {
                    const ointSymbol = `<svg viewBox="0 0 79 197" xmlns="http://www.w3.org/2000/svg" style="height: 2.75em; width:auto;"> <defs> <mask id="cutout"> <rect width="542.111" height="263.118" fill="white" x="-0.126" y="-1.178"></rect> <circle cx="42.938" cy="96.4" r="19.843" fill="black"></circle> </mask> </defs> <ellipse style="stroke: rgba(0, 0, 0, 0.19); stroke-width: 0.2px;" cx="74.696" cy="8.205" rx="4.429" ry="4.429"></ellipse> <path style="stroke-width: 0.2px; stroke: rgba(0, 0, 0, 0);" d="M 79.153 7.976 C 79.153 7.976 79.315 8.26 78.825 5.813 C 78.335 3.366 75.101 1.386 73.461 0.742 C 71.821 0.097 68.438 -0.943 64.672 1.816 C 60.906 4.576 57.107 14.28 57.166 14.268 C 56.927 14.196 52.986 26.822 47.438 50.304 C 41.891 73.788 36.463 100.54 36.551 100.54 C 36.551 100.54 37.166 97.119 34.454 111.48 C 31.742 125.84 31.04 130.661 26.721 154.764 C 22.403 178.866 17.658 194.02 10.938 194.757 C 4.217 195.493 0.737 187.13 0.737 187.13 L 0.296 186.893 C 0.296 186.893 -1.193 192.582 5.647 195.562 C 12.487 198.542 17.329 193.767 18.582 192.921 C 19.834 192.074 25.766 185.612 30.908 165.643 C 36.05 145.673 38.911 132.911 38.911 132.911 C 38.911 132.911 42.648 118.634 47.077 94.311 C 51.506 69.988 54.986 49.529 58.856 29.972 C 62.726 10.415 66.441 4.14 67.103 3.61 C 67.765 3.08 68.03 1.889 70.192 1.844 C 72.355 1.8 75.135 3.919 75.135 3.919 L 79.153 7.976 Z"></path> <ellipse style="stroke: rgba(0, 0, 0, 0);" cx="4.525" cy="188.381" rx="4.483" ry="4.483"></ellipse> <circle cx="42.938" cy="96.4" r="22.448" style="mask: url(#cutout);"></circle> </svg>`;
                    var htmlTemplate = '<span class="mq-int mq-non-leaf mq-large-operator">' + ointSymbol + '<span class="mq-supsub mq-int-bounds mq-non-leaf">' + '<span class="mq-sup"><span class="mq-sup-inner mq-tabbable-upper">&1</span></span>' + '<span class="mq-sub mq-tabbable-lower">&0</span>' + '<span style="display:inline-block;width:0">&#8203</span>' + "</span>" + "</span>";
    ...
    LatexCmds["dashint"] = LatexCmds.integral = P(SummationNotation, function (_, super_) {
        _.init = function () {
            const dashintsymbol = `<svg viewBox="-0.036 -0.256 137.695 341.953" style="height: 2.75em; width:auto;"> <ellipse style="stroke: rgba(0, 0, 0, 0.19); stroke-width: 0.2px;" cx="129.859" cy="14.016" rx="7.708" ry="7.708"></ellipse> <path style="stroke-width: 0.2px; stroke: rgba(0, 0, 0, 0);" d="M 137.614 13.618 C 137.614 13.618 137.897 14.113 137.045 9.855 C 136.193 5.597 130.565 2.152 127.71 1.031 C 124.857 -0.09 118.971 -1.902 112.417 2.901 C 105.865 7.702 99.255 24.588 99.358 24.566 C 98.943 24.442 92.084 46.409 82.432 87.269 C 72.781 128.129 63.336 174.678 63.488 174.678 C 63.488 174.678 64.559 168.724 59.84 193.712 C 55.122 218.699 53.899 227.088 46.386 269.025 C 38.871 310.962 30.616 337.331 18.922 338.613 C 7.228 339.893 1.173 325.343 1.173 325.343 L 0.406 324.93 C 0.406 324.93 -2.185 334.828 9.716 340.013 C 21.619 345.199 30.043 336.891 32.222 335.417 C 34.402 333.946 44.723 322.702 53.67 287.955 C 62.618 253.209 67.595 231.003 67.595 231.003 C 67.595 231.003 74.098 206.161 81.804 163.84 C 89.509 121.518 95.565 85.92 102.299 51.892 C 109.033 17.862 115.496 6.944 116.647 6.021 C 117.8 5.099 118.26 3.027 122.024 2.95 C 125.787 2.872 130.625 6.558 130.625 6.558 L 137.614 13.618 Z"></path> <ellipse style="stroke: rgba(0, 0, 0, 0);" cx="7.764" cy="327.519" rx="7.8" ry="7.8"></ellipse> <rect x="28.981" y="157.674" width="91.626" height="2.824" style="stroke: rgba(255, 255, 255, 0);"></rect> </svg>`;
            var htmlTemplate = '<span class="mq-int mq-non-leaf mq-large-operator">' + dashintsymbol + '<span class="mq-supsub mq-int-bounds mq-non-leaf">' + '<span class="mq-sup"><span class="mq-sup-inner mq-tabbable-upper">&1</span></span>' + '<span class="mq-sub mq-tabbable-lower">&0</span>' + '<span style="display:inline-block;width:0">&#8203</span>' + "</span>" + "</span>";
            Symbol.prototype.init.call(this, "\\dashint", htmlTemplate);
        };
        // FIXME: refactor rather than overriding
        _.createLeftOf = MathCommand.p.createLeftOf;
    });
    LatexCmds["lim"] = LatexCmds.limit = P(SummationNotation, function (_, super_) {
        _.init = function () {
            var htmlTemplate = '<span class="mq-large-operator mq-non-leaf mq-limit">' + "lim" + "" + "<div>&0</div></span>";
    ...
    LatexCmds["Res"] = LatexCmds.limit = P(SummationNotation, function (_, super_) {
        _.init = function () {
            var htmlTemplate = '<span class="mq-large-operator mq-non-leaf mq-limit">' + "Res" + "" + "<div class='mq-res'><span>&0</span></div></span>";
            Symbol.prototype.init.call(this, "\\Res", htmlTemplate);
        };
        // FIXME: refactor rather than overriding
        _.createLeftOf = MathCommand.p.createLeftOf;
        _.latex = function () {
    ...
    var Fraction =
        ...
        LatexCmds.fraction =
            P(MathCommand, function (_, super_) {
                _.ctrlSeq = "\\frac";
                _.htmlTemplate = '<span class="mq-fraction mq-non-leaf">' + '<span class="mq-numerator mq-tabbable-upper">&0</span>' + '<span class="mq-denominator mq-tabbable-lower">&1</span>' + '<span style="display:inline-block;width:0">&#8203;</span>' + "</span>";
                _.textTemplate = ["(", ")/(", ")"];
                _.finalizeTree = function () {
            ...
            P(Fraction, function (_, super_) {
                _.createLeftOf = function (cursor) {
                    if (!this.replacedFragment) {
                        ...
                        while (
                            leftward &&
                            !(leftward instanceof BinaryOperator || leftward instanceof (LatexCmds.text || noop) || leftward instanceof SummationNotation || leftward.ctrlSeq === "\\ " || /^[,;:]$/.test(leftward.ctrlSeq)) //lookbehind for operator
                        )
                            leftward = leftward[L];
    ...
    LatexCmds["Solve"] = LatexCmds.Solve = P(SquareRoot, function (_, super_) {
        _.ctrlSeq = "\\Solve";
        _.htmlTemplate = `<span class="mq-operator-name">Solve</span><span class="SV-Solve mq-non-leaf" data=""><div class="SV-Solve-hide-upper"></div><div class="mq-non-leaf SV-Solve-inner">&0</div><div class="SV-Solve-hide-lower"></div></span><button class="SV-Solve-Button">run</button>`;
        _.textTemplate = ["Solve(", ")"];
        _.latex = function () {
            return "\\Solve{" + this.ends[R].latex() + "}";
        };
    });

    LatexCmds["Calc"] = LatexCmds.Calc = P(SquareRoot, function (_, super_) {
        _.ctrlSeq = "\\Calc";
        _.htmlTemplate = `<span class="mq-operator-name">Calc</span><span class="SV-Solve mq-non-leaf" data=""><div class="SV-Solve-hide-upper"></div><div class="mq-non-leaf SV-Calc-inner">&0</div><div class="SV-Solve-hide-lower"></div></span><button class="SV-Calc-Button">run</button>`;
        _.textTemplate = ["Calc(", ")"];
        _.latex = function () {
            return "\\Calc{" + this.ends[R].latex() + "}";
        };
    });

    LatexCmds["Graph"] = LatexCmds.Graph = P(SquareRoot, function (_, super_) {
        _.ctrlSeq = "\\Graph";
        _.htmlTemplate = `<span class="mq-operator-name">Graph</span><span class="SV-Solve mq-non-leaf" data=""><div class="SV-Solve-hide-upper"></div><div class="mq-non-leaf SV-Graph-inner">&0</div><div class="SV-Solve-hide-lower"></div></span><button class="SV-Graph-Button">run</button>`;
        _.textTemplate = ["Graph(", ")"];
        _.latex = function () {
            return "\\Graph{" + this.ends[R].latex() + "}";
        };
    });

    var Hat = (LatexCmds.hat = P(MathCommand, function (_, super_) {
        _.ctrlSeq = "\\hat";
        _.htmlTemplate = '<span class="mq-non-leaf">' + '<span class="mq-hat-prefix">^</span>' + '<span class="mq-hat-stem">&0</span>' + "</span>";
        _.textTemplate = ["hat(", ")"];
    }));
    ...
    var DiacriticAbove = P(MathCommand, function (_, super_) {
        _.init = function (ctrlSeq, symbol, textTemplate) {
            var htmlTemplate = '<span class="mq-non-leaf">' + '<span class="mq-diacritic-above">' + symbol + "</span>" + '<span class="mq-diacritic-stem">&0</span>' + "</span>";
    ...
    var Bracket = P(P(MathCommand, DelimsMixin), function (_, super_) {
        ...
        _.html = function () {
            ...
            this.htmlTemplate = '<span class="mq-non-leaf">' + '<span class="mq-scaled mq-paren' + (this.side === R ? " mq-ghost" : "") + '">' + this.sides[L].ch + "</span>" + '<span class="mq-non-leaf">&0</span>' + '<span class="mq-scaled mq-paren' + (this.side === L ? " mq-ghost" : "") + '">' + this.sides[R].ch + "</span>" + "</span>"; // be set by createLeftOf or parser
        ...
        _.matchBrack = function (opts, expectedSide, node) {
            ...
            return node instanceof Bracket && node.side && node.side !== -expectedSide && (!opts.restrictMismatchedBrackets || OPP_BRACKS[this.sides[this.side].ch] === node.sides[node.side].ch || { "(": "]", "[": ")" }[this.sides[L].ch] === node.sides[R].ch) && node;
        };
        ...
        _.createLeftOf = function (cursor) {
            if (!this.replacedFragment) {
                ...
                if (this.sides[L].ch === "|") {
                    ...
                    var brack = this.matchBrack(opts, R, cursor[R]) || this.matchBrack(opts, L, cursor[L]) || this.matchBrack(opts, 0, cursor.parent.parent);
                } else {
                    var brack = this.matchBrack(opts, -this.side, cursor[-this.side]) || this.matchBrack(opts, -this.side, cursor.parent.parent);
                }
            }
            if (brack) {
        ...
        _.deleteSide = function (side, outward, cursor) {
            ...
            if (this.matchBrack(opts, side, this.ends[L].ends[this.side])) {
                ...
                if (this.matchBrack(opts, side, this.parent.parent)) {
                    ...
                    this.sides[side] = { ch: OPP_BRACKS[this.sides[this.side].ch], ctrlSeq: OPP_BRACKS[this.sides[this.side].ctrlSeq] };
                    this.delimjQs
                        .removeClass("mq-ghost")
                        .eq(side === L ? 0 : 1)
                        .addClass("mq-ghost")
    ...
    LatexCmds.left = P(MathCommand, function (_) {
        _.parser = function () {
            ...
            return optWhitespace.then(regex(/^(?:[([|]|\\\{|\\langle\b|\\lVert\b|\\lfloor\b|\\lceil\b)/)).then(function (ctrlSeq) {
                ...
                return latexMathParser.then(function (block) {
                    return string("\\right")
                        .skip(optWhitespace)
                        .then(regex(/^(?:[\])|]|\\\}|\\rangle\b|\\rVert\b|\\rfloor\b|\\rceil\b)/))
                        .map(function (end) {
    ...
    var Binomial =
        ...
        LatexCmds.binomial =
            P(P(MathCommand, DelimsMixin), function (_, super_) {
                _.ctrlSeq = "\\binom";
                _.htmlTemplate = '<span class="mq-non-leaf">' + '<span class="mq-paren mq-scaled">(</span>' + '<span class="mq-non-leaf">' + '<span class="mq-array mq-binom mq-non-leaf">' + "<span>&0</span>" + "<span>&1</span>" + "</span>" + "</span>" + '<span class="mq-paren mq-scaled">)</span>' + "</span>";
    ...
    LatexCmds.begin = P(MathCommand, function (_, super_) {
        _.parser = function () {
            ...
            return string("{")
                ...
                .skip(string("}"))
                .then(function (env) {
                    return (Environments[env] ? Environments[env]().parser() : Parser.fail("unknown environment type: " + env)).skip(string("\\end{" + env + "}"));
                });
        };
    });
    ...
    var Env = (Environments.gather = P(Environment, function (_, super_) {
        var delimiters = {
            column: "&",
            row: "\\\\",
        };
        _.keybinds = {
            col: "Ctrl-Shift-Spacebar",
            row: "Enter",
        };
        ...
        _.html = function () {
            ...
            this.eachChild(function (cell) {
                if (row !== cell.row) {
                    row = cell.row;
                    trs += '<tr class="mq-tablock">$tds</tr>';
                    cells[row] = [];
                }
                cells[row].push('<td class="mq-tablock">&' + i++ + "</td>");
            });

            this.htmlTemplate =
                '<span class="mq-matrix mq-non-leaf mq-tablock mq-' +
                this.environment +
                '">' +
                '<table class="mq-non-leaf mq-tablock mq-gather">' +
        ...
        // Create default 1-cell matrix
        _.createBlocks = function () {
            this.blocks = [_.matrixcell(_.keybinds, 0, this)];
        };
        _.parser = function () {
            var self = this;
            var optWhitespace = Parser.optWhitespace;
            ...
            return optWhitespace
                ...
                .then(function (items) {
                    ...
                    function addCell() {
                        self.blocks.push(_.matrixcell(_.keybinds, row, self, blocks));
                        blocks = [];
                    }
            ...
            if (maxLength !== Math.min.apply(null, lengths)) {
                ...
                for (i = 0; i < rows.length; i += 1) {
                    ...
                    while (shortfall) {
                        ...
                        blocks.splice(position, 0, _.matrixcell(_.keybinds, i, this));
                        shortfall -= 1;
                    }
                }
                this.relink();
        ...
        _.addRow = function (afterCell) {
            var previous = [],
                newCells = [],
                next = [];
            var newRow = $('<tr class="mq-tablock"></tr>'),
                row = afterCell.row;
            var columns = 0,
                block,
                column;
            ...
            for (var i = 0; i < columns; i += 1) {
                block = _.matrixcell(_.keybinds, row + 1);
                block.parent = this;
                newCells.push(block);

                // Create cell <td>s and add to new row
                block.jQ = $('<td class="mq-empty mq-tablock">').attr(mqBlockId, block.id).appendTo(newRow);
            }
        ...
        _.addColumn = function (afterCell) {
            ...
            for (var i = 0; i < rows.length; i += 1) {
                block = _.matrixcell(_.keybinds, i);
                block.parent = this;
                newCells.push(block);
                rows[i].splice(column, 0, block);

                block.jQ = $('<td class="mq-empty mq-tablock">').attr(mqBlockId, block.id);
            }
        ...
        _.matrixcell = P(MathBlock, function (_, super_) {
            _.init = function (keybinds, row, parent, replaces) {
                super_.init.call(this);
                this.row = row;
                if (parent) {
            ...
            _.keystroke = function (key, e) {
                switch (key) {
                    case this.keybinds.col:
                        e.preventDefault();
                        return this.parent.insert("addColumn", this);
                        break;
                    case this.keybinds.row:
    ...
    var Matrix = (Environments.matrix = P(Environment, function (_, super_) {
        ...
        _.reflow = function () {
            ...
            if (parens.length) {
                scale(parens, min(1 + 0.8 * (height - 1), 1.5), 1.15 * height);
            }
        };
        _.latex = function () {
            var latex = "";
        ...
        _.html = function () {
            ...
            function parenHtml(paren) {
                return paren ? '<span class="mq-scaled mq-paren mq-tablock">' + paren + "</span>" : "";
            }
            ...
            this.htmlTemplate =
                '<span class="mq-matrix mq-non-leaf mq-tablock mq-' +
                this.environment +
                '"> <div class="mq-matrix-hide-upper"></div>' +
                parenHtml(this.parentheses.left) +
                '<table class="mq-non-leaf mq-tablock">' +
                trs.replace(/\$tds/g, function () {
                    return cells.shift().join("");
                }) +
                "</table>" +
                parenHtml(this.parentheses.right) +
                "<span style='margin-right: 10px;'></span><div class='mq-matrix-hide-lower'></div></span>";
    ...
    // Save index 123123
    Environments.array = P(Env, function (_, super_) {
        _.environment = "array";
    });
    Environments.align = P(Env, function (_, super_) {
        _.environment = "align";
        _.keybinds = {
            col: "Shift-Spacebar",
            row: "Enter",
    ...
    Environments.cases = P(Matrix, function (_, super_) {
        _.environment = "cases";
        _.parentheses = {
            left: `<svg viewBox="0.0 0.0 193.638 502.596" width="auto" height="1em"> <path style="stroke: rgba(0, 0, 0, 0);" d="M 125.066 291.403 L 128.609 459.234 C 131.687 490.925 191.869 502.591 191.869 502.591 C 191.869 502.591 86.011 503.24 77.176 457.208 C 75.036 457.543 74.017 291.023 75.006 291.263 C 75.994 291.503 60.242 253.105 0.025 252.62 C 75.438 246.094 79.688 204.406 79.688 204.406 L 79.688 59.015 C 81.096 2.222 193.663 -0.005 193.663 -0.005 C 193.663 -0.005 126.557 16.189 127.26 59.595 L 127.26 204.673 C 126.413 204.625 129.185 253.16 43.896 251.984 C 50.49 251.561 121.915 261.391 125.066 291.403 Z"></path> </svg>`,
            right: "",
        };
    });
    ...
    Environments.amatrix = P(Matrix, function (_, super_) {
        _.environment = "amatrix";
        _.parentheses = {
            left: "",
            right: "",
        };
        _.createBlocks = function () {
            this.blocks = [_.matrixcell(_.keybinds, 0, this), _.matrixcell(_.keybinds, 0, this), _.matrixcell(_.keybinds, 0, this), _.matrixcell(_.keybinds, 1, this), _.matrixcell(_.keybinds, 1, this), _.matrixcell(_.keybinds, 1, this)];
        };
    });
