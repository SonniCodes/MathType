...
(function () {
	...
	*/
	...
	var IntegralNotation = P(MathCommand, function (_, super_) {
		_.init = function (ch, html) {
			var htmlTemplate =
				...
				'<span class="mq-non-leaf" style="position: relative;">'
				+ '<span class="integral-fix"><span class="integral-fix" style="position: absolute; top: -6px; left: 24px;"><small>&1</small></span></span>'
				+ html
				+ '<span class="integral-fix"><span class="integral-fix" style = "position: absolute; bottom:-2px; left: 13px"><small>&0</small></span></span>'
				+ '</span>'
				;
			Symbol.prototype.init.call(this, ch, htmlTemplate);
		};
	...
	var EvaluatedAt = P(MathCommand, function (_, super_) {
		_.init = function (ch, html) {
			var htmlTemplate =
				...
				'<span class="mq-non-leaf" style="0.2em; margin-right:0.2em;">'
				+ '<span class="integral-fix"><span class="integral-fix"><small>&1</small></span></span>'
				+ '<svg style="height:1em; width:auto;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 500"><rect x="6" y="0" width="15" height="500"/></svg>'
				+ '<span class="integral-fix"><span class="integral-fix" style = ""><small>&0</small></span></span>'
				+ '</span>';
			Symbol.prototype.init.call(this, ch, htmlTemplate);
		};
		_.latex = function () {
			...
			return '\\rvert' + '_' + simplify(this.ends[L].latex()) +
				'^' + simplify(this.ends[R].latex());
		};
		_.parser = function () {
			var string = Parser.string;
	...
	var Limit = P(MathCommand, function (_, super_) {
		_.init = function (ch, html) {
			var htmlTemplate =
				'<span class="mq-binary-operator mq-non-leaf">'
				+ '<span style = "margin-bottom: 0px; margin-right:0px !important;">' + html + '</span>'
				+ '<div class="mq-from" style = "margin-top: -6px !important;"><small>&0</small></div>'
				+ '</span>'
				;
			Symbol.prototype.init.call(this, ch, htmlTemplate);
		};
